<template>
  <div id="content">
    <Navbar />
    <div
      class="flex justify-center items-center px-4 py-12 min-h-full sm:px-6 lg:px-8"
    >
      <div class="space-y-8 w-full max-w-md">
        <div>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="mx-auto w-10 w-auto h-10 h-12 text-indigo-500"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
        ...
        <form class="mt-8 space-y-6" action="#" method="POST" netlify>
          ...
          <div>
            <button
              type="submit"
              class="flex relative justify-center px-4 py-2 w-full text-sm font-medium text-white bg-indigo-500 rounded-md border border-transparent group hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700"
            >
              Submit
            </button>
          </div>
